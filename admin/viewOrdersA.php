...
<?php
    ...
    if(isset($_GET['order'])){
        ...
        $queryOrderNo = "SELECT * FROM orders WHERE order_no='$order_no'";
        $result = mysqli_query($db_con, $queryOrderNo);
    ...
    if(isset($_POST['updateStatus'])){
        ...
        $update_status = "UPDATE orders SET order_status='$order_status' WHERE order_no='$order_no'";
...
<div class="py-3 py-md-4 checkout">
        <div class="container">
            ...
            <a href="orders.php"><button class="btn btn-warning float-end"><i class="fa fa-reply"></i> Back</button></a>
            <hr>
            ...
            <div class="row">
                <div class="col-md-12 mb-4">
                    ...
                    <div class="shopping-cart">
                        ...
                        $order_query = "SELECT o.id as oid, o.order_no, o.user_id, oi.*, p.* FROM orders o, order_items oi, products p WHERE oi.order_id=o.id AND p.id=oi.prod_id AND o.order_no='$order_no'";
                                    ...
                                    <label>Order Status</label>
                                        <div class="">
                                            ...
                                            <select name="order_status" id="" class="form-select">
                                                <option value="0" <?php if($data['order_status'] == 0){echo "selected";}else{" ";} ?> >Under Process</option>
                                                <option value="1"<?php if($data['order_status'] == 1){echo "selected";}else{" ";} ?>>Completed</option>
                                            </select>
                                            <div class="mt-2 float-end">
                                                <button name="updateStatus" type="submit" class="btn btn-outline-success">Update Order Status</button>
                                            </div>
                                    </div>
                                </div>
                            </div>
